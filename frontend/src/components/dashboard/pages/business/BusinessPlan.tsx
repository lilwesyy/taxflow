      ...
      <div className="h-full flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 w-full max-w-3xl">
          <div className="text-center mb-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Business Plan Predittivo VisionFlow</h1>
            <p className="text-sm text-gray-600">Sistema di pianificazione strategica con analisi predittiva D.Lgs. 14/2019</p>
          </div>

          <div className="bg-gradient-to-r from-primary-50 to-purple-50 border border-primary-200 rounded-xl p-5 mb-4">
            <div className="text-center">
              <p className="text-sm text-gray-600 mb-1">Investimento una tantum</p>
              <p className="text-4xl font-bold text-primary-600 my-2">€998</p>
          ...
          <div className="grid md:grid-cols-2 gap-3 mb-4">
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Executive Summary + Obiettivo</h3>
                  <p className="text-sm text-gray-600">Riepilogo professionale con obiettivi chiari</p>
                </div>
              </div>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <div className="flex items-start space-x-2">
                <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Analisi di Mercato</h3>
                  <p className="text-sm text-gray-600">Studio mercato e competitor</p>
                </div>
              </div>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <div className="flex items-start space-x-2">
                <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Time Series Forecasting</h3>
                  <p className="text-sm text-gray-600">Proiezioni finanziarie avanzate</p>
                </div>
              </div>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <div className="flex items-start space-x-2">
                <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Simulazione Budget + Alert</h3>
                  <p className="text-sm text-gray-600">Sistema allerta precoce</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <button
              ...
              disabled={purchasing}
              className="bg-primary-600 text-white px-8 py-3 rounded-lg hover:bg-primary-700 transition-all duration-200 hover:scale-105 hover:shadow-lg flex items-center justify-center mx-auto disabled:opacity-50"
            >
              {purchasing ? (
                <>
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-base font-bold text-gray-900">Business Plan Completato</h1>
          ...
          {content?.pdfUrl && (
            <a
              ...
              className="bg-primary-600 text-white px-3 py-1.5 rounded-lg hover:bg-primary-700 transition-all duration-200 flex items-center text-xs"
            >
