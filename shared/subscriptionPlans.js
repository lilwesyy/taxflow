...
exports.SETUP_FEE = exports.SUBSCRIPTION_PLANS = void 0;
...
function getPlanById(planId) {
    return exports.SUBSCRIPTION_PLANS.find(plan => plan.id === planId);
}
// Helper function to get plan by Stripe Price ID
function getPlanByStripePriceId(stripePriceId) {
    return exports.SUBSCRIPTION_PLANS.find(plan => plan.stripePriceId === stripePriceId);
}
